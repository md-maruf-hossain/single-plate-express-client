    ...
    <section className="py-6 bg-gray-100 text-gray-900">
      <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
        <div className="flex flex-col justify-center lg:text-left">
          <p className="mb-1 text-sm font-medium tracking-widest uppercase text-green-600">Exciting Features Coming Soon</p>
          <h1 className="py-2 text-3xl font-medium leading-tight title-font">Experience Innovation with Our App</h1>
        ...
        <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
          <Link href="/coming-soon">
            <button className="inline-flex items-center px-6 py-3 rounded-lg bg-green-700 text-gray-50 cursor-pointer">
          ...
          <Link href="/coming-soon">
            <button className="inline-flex items-center px-5 py-3 rounded-lg bg-green-700 text-gray-50 cursor-pointer">
